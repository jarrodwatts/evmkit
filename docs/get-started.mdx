...
For the best IDE experience, it&rsquo;s recommended to install these extensions.
...
You&rsquo;ll now be able to view your application at [http://localhost:3000](http://localhost:3000).
